...
- [Demo-react-storybook](https://gaurav101.github.io/LuminaJS/storybook/)
- [Demo-vanilla-js](https://gaurav101.github.io/LuminaJS/)
...
# 2. Build every Nx project
npm run build

# Or build only the publishable package
npm run build:lib
```

The package output is generated in `packages/luminajs/dist/`. Application
outputs are generated in each app's `dist/` folder under `apps/*`.
